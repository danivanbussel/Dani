...
module.exports.run = async (bot, message, args) => {
    ...
    var reviewChannel = message.guild.channels.cache.find(c => c.name == "review"); 
    ...
    message.channel.send("``Bedankt voor je review! wij gaan er zeker naar kijken! We contacteren je later via DM!``");
